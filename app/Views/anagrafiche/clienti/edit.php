...
?>
<?= $this->section('title') ?><?= esc($denom) ?><?= $this->endSection() ?>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade show active" id="pane-anagrafica" role="tabpanel">
                    ...
                    <div class="card-footer d-flex justify-content-between align-items-center">
                        ...
                        <!-- form="form-update" collega il bottone al form update anche se è fuori dall'elemento <form> -->
                ...
                <div class="tab-pane fade" id="pane-materiali" role="tabpanel">
                    <div class="card-body text-center py-5 text-muted">
                        ...
                        <p class="mt-3 mb-0">Lo storico materiali sarà disponibile dalla versione 0.8.0.</p>
                    </div>
                </div>
